...
CREATE TABLE AUTHENTICATION.USER_MENU (
   USERNAME VARCHAR(100) NOT NULL,
   MENU_CODE VARCHAR(100) NOT NULL,
   CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
   PRIMARY KEY (USERNAME, MENU_CODE),
   CONSTRAINT USER_MENU_USER_FK FOREIGN KEY (USERNAME)
          REFERENCES AUTHENTICATION.USER(USERNAME)
          ON DELETE CASCADE
          ON UPDATE CASCADE,
   CONSTRAINT USER_MENU_MENU_FK FOREIGN KEY (MENU_CODE)
...
INSERT INTO SYSTEM.PARAMETER ( CODE, TYPE, VALUE, CREATED_AT )
VALUES ('PASSWORD_EXPIRATION_CONTROL', 'STATUS', 'ACTIVE', CURRENT_TIMESTAMP);

INSERT INTO SYSTEM.PARAMETER ( CODE, TYPE, VALUE, CREATED_AT )
VALUES ('PASSWORD_EXPIRATION_DAYS', 'NUMERIC', '90', CURRENT_TIMESTAMP);

INSERT INTO SYSTEM.PARAMETER ( CODE, TYPE, VALUE, CREATED_AT )
VALUES ('RESET_PASSWORD_TOKEN_EXPIRATION_CONTROL', 'STATUS', 'ACTIVE', CURRENT_TIMESTAMP);

INSERT INTO SYSTEM.PARAMETER ( CODE, TYPE, VALUE, CREATED_AT )
VALUES ('RESET_PASSWORD_TOKEN_EXPIRATION_MINUTES', 'NUMERIC', '15', CURRENT_TIMESTAMP);

INSERT INTO SYSTEM.PARAMETER ( CODE, TYPE, VALUE, CREATED_AT )
VALUES ('VERIFY_ACCOUNT_TOKEN_EXPIRATION_CONTROL', 'STATUS', 'ACTIVE', CURRENT_TIMESTAMP);

INSERT INTO SYSTEM.PARAMETER ( CODE, TYPE, VALUE, CREATED_AT )
VALUES ('VERIFY_ACCOUNT_TOKEN_EXPIRATION_MINUTES', 'NUMERIC', '60', CURRENT_TIMESTAMP);
