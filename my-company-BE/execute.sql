...
CREATE TABLE IF NOT EXISTS AUTHENTICATION.USER (
   ...
   PASSWORD2 TEXT,
   PASSWORD3 TEXT,
   PASSWORD_VALID_UNTIL TIMESTAMP NOT NULL,
...
VALUES ('ADMIN', '$2a$10$GpjqI0xExRcLcBAlaSgm8uC4mwaq0ysrpdOiM0Ull0PpmEP00FaVS', NULL, NULL, (CURRENT_TIMESTAMP + INTERVAL '90 days'), 'LOCAL', NULL, 'ACTIVE', CURRENT_TIMESTAMP);
