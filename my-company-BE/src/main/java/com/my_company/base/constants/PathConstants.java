package com.my_company.base.constants;
...
public class PathConstants {
    ...
    public static final String API_V1_AUTHENTICATION_LOGIN_URL = API_V1_AUTHENTICATION_URL + "/login";
    public static final String API_V1_AUTHENTICATION_LOCAL_SIGN_UP_URL = API_V1_AUTHENTICATION_URL + "/local-sign-up";
